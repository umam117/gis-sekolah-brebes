...
(1, 'TK', 'tk.png'),
(2, 'SD', '1780204468_8a693b70ca2f64003b1d.png'),
(3, 'SMP', 'smp.png'),
(4, 'SMA', 'sma.png');
...
(1, 4, 'SMA NEGRI 1 BUMIAYU', 'A', 'Negri', '-7.234943047455974, 109.01086561733622', NULL, 'Jalan P. Diponegoro No. 02, Bumiayu, Taloksari, Dukuhturi, Kec. Bumiayu, Kabupaten Brebes, Jawa Tengah 52273', NULL, NULL, NULL, 1),
(2, 3, 'SMP NEGRI 2 BUMIAYU', 'A', 'Negri', '-7.271395171551092, 108.98579526420014', NULL, 'Jl. Raya Pruwatan No.41, Karangjatisekolahan, Laren, Kec. Bumiayu, Kabupaten Brebes, Jawa Tengah 52273', NULL, NULL, NULL, 1);
...
(1, 'WEB GIS Sekolah Brebes', '-7.246755513355762, 109.01522180346667', 10);
...
CREATE TABLE `tbl_wilayah` (
  ...
  `geojson` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
...
--
ALTER TABLE `tbl_wilayah`
  MODIFY `id_wilayah` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
COMMIT;
